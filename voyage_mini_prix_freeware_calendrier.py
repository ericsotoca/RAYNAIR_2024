...
# Utilisez DateEntry pour les champs de date de début et de fin, avec le paramètre state='disabled' pour les griser
entry_date_debut = DateEntry(window, width=12, background='lightblue', foreground='black', borderwidth=2, state="readonly", date_pattern='dd-mm-yyyy')
entry_date_fin = DateEntry(window, width=12, background='lightblue', foreground='black', borderwidth=2, state="readonly", date_pattern='dd-mm-yyyy')
